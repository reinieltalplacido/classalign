...
import { ArrowUpRight, Check, Calendar, Clock, Brain } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
              Create, manage, and optimize your class schedule with intelligent
              suggestions. Never miss a class or deal with scheduling conflicts
              again.
            </p>
